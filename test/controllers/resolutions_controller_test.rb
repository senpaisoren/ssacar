...
class ResolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resolution" do
    assert_difference('Resolution.count') do
      post resolutions_url, params: { resolution: { content: @resolution.content, reported: @resolution.reported, solved: @resolution.solved, texttype: @resolution.texttype, title: @resolution.title } }
    end
  ...
  test "should update resolution" do
    patch resolution_url(@resolution), params: { resolution: { content: @resolution.content, reported: @resolution.reported, solved: @resolution.solved, texttype: @resolution.texttype, title: @resolution.title } }
